  ...
  `}function p(a){return`
    <div class="glass-card journey-card-content" data-aos="fade-up">
        <div class="journey-card-image">
            <img src="${d+a.image}" alt="Moroccan Landscape">
    ...
    `}document.addEventListener("DOMContentLoaded",()=>{const a={"marrakech-medina-grid":o.marrakech_medina,"marrakech-gardens-grid":o.marrakech_gardens,"marrakech-adventure-grid":o.marrakech_adventure,"marrakech-wellness-grid":o.marrakech_wellness,"marrakech-dining-grid":o.marrakech_dining,"journey-data-card":o.journey_transition,"journey-bus-grid":o.journey_bus,"essaouira-grid":o.essaouira};Object.entries(a).forEach(([e,s])=>{const c=document.getElementById(e);if(!c)return;const m=e.includes("essaouira")?"blue":e.includes("journey")?"mixed":"terracotta";e==="journey-data-card"?c.innerHTML=s.map(l=>p(l)).join(""):c.innerHTML=s.map(l=>g(l,m)).join("")});const i=document.getElementById("lightbox"),t=document.getElementById("lightbox-img"),n=document.querySelector(".lightbox-close");document.addEventListener("click",e=>{const s=e.target.closest(".card-image img");s&&(i.style.display="flex",t.src=s.src,document.body.style.overflow="hidden")});const r=()=>{i.style.display="none",document.body.style.overflow="auto"};n.onclick=r,i.onclick=e=>{e.target!==t&&r()}});
