    ...
    <div class="glass-card location-card" data-id="${a.id}" data-aos="fade-up">
      ...
      <div class="card-content">
        ...
        <div class="card-details">
          ...
          <div class="detail-row"><span class="label">🎟 Price:</span> <span class="price-highlight">${a.price.eur==="Free"&&a.price.mad==="Free"?"Free":`${a.price.eur} <small>(${a.price.mad})</small>`}</span></div>
